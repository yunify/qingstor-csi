...
// Volume Method
func (m *mockCloudManager) FindVolume(volId string) (volInfo *cloud.Volume, err error) {
	panic("implement me")
}

func (m *mockCloudManager) FindVolumeByName(volName string) (volInfo *cloud.Volume, err error) {
	panic("implement me")
}


func (m *mockCloudManager) NodeAttachVolume(volId string) error {
	panic("implement me")
}

func (m *mockCloudManager) NodeDetachVolume(volId string) error {
	panic("implement me")
}

func (m *mockCloudManager) NodeGetDevice(volId string) (string, error) {
	panic("implement me")
}

func (m *mockCloudManager) Probe() error {
	panic("implement me")
}

func (m *mockCloudManager) GetTopology(instanceId string) (*csi.Topology, error) {
	panic("implement me")
}
