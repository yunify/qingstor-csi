...
func (cs *ControllerServer) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse,
	...
	klog.Info(common.EntryFunction2(funcName, hash))
...
func (cs *ControllerServer) IsValidTopology(volume *cloud.Volume, requirement *csi.TopologyRequirement) bool {
	if volume == nil {
		return false
	}
...
func (cs *ControllerServer) GetVolumeTopology(volume *cloud.Volume) []*csi.Topology {
	if volume == nil {
		return nil
	}
