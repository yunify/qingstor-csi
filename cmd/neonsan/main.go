...
import (
	"flag"
	"github.com/yunify/qingcloud-csi/pkg/cloud/neonsan"
	"github.com/yunify/qingcloud-csi/pkg/common"
	"github.com/yunify/qingcloud-csi/pkg/disk/driver"
	neonsandriver "github.com/yunify/qingcloud-csi/pkg/disk/driver/neonsan"
...
var (
	...
	//endpoint         = flag.String("endpoint", "tcp://:10086", "CSI endpoint")
...
func handle() {
	...
	mounter := common.NewFakeFormatAndMount()
